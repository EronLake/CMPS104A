...
fielddecl : basetype TOK_ARRAY TOK_IDENT
                                { 
                                  $3->convert_sym(TOK_FIELD);
                                  $$ = $2->adopt($1,$3); 
                                }
          | basetype TOK_IDENT  
                                { 
                                  $2->convert_sym(TOK_FIELD);
                                  $$ = $1->adopt($2); 
                                }
          ;
...
identdecl : basetype TOK_ARRAY TOK_IDENT
                                { 
                                  $3->convert_sym(TOK_DECLID);
                                  $$ = $2->adopt($1,$3); 
                                }
          | basetype TOK_IDENT  
                                { 
                                  $2->convert_sym(TOK_DECLID);
                                  $$ = $1->adopt($2); 
                                }
          ;
...
allocator : TOK_NEW TOK_IDENT '(' ')'  
          ...
          | TOK_NEW TOK_STRING  '(' expr ')'      
                                { 
                                  destroy($2,$3,$5); 
                                  $1->convert_sym(TOK_NEWSTRING);
                                  $$ = $1->adopt($4); 
                                }
          | TOK_NEW basetype  '[' expr ']'        
                                { 
                                  destroy($3,$5); 
                                  $1->convert_sym(TOK_NEWARRAY);
                                  $2->convert_sym(TOK_TYPEID);
                                  $$ = $1->adopt($2,$4); 
                                }
          ;
